...
export default function StudentSidebar() {
    ...
    return (
        <aside className="w-64 bg-white border-r border-gray-200 fixed left-0 top-16 bottom-0 overflow-y-auto hidden md:block z-20">
            <div className="py-6 px-4">
                ...
                <div className="mt-8 px-4">
                    <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-100">
                        ...
                        <p className="text-xs text-indigo-700 mb-3">Google India Recruitment Drive starts tomorrow.</p>
