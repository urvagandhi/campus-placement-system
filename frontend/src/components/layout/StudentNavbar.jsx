                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-3 pl-2 sm:pl-0">
                            <div className="hidden sm:block text-right">
                                <p className="text-sm font-semibold text-gray-900 leading-none">{user?.name || 'Student Name'}</p>
                                <p className="text-xs text-gray-500 mt-1">{formatRole(user?.role || 'Student')}</p>
                            </div>
