...
import { Lock, Save, User, Phone, Mail, Shield, Building, Globe, MapPin, Hash } from 'lucide-react';
    ...
    useEffect(() => {
        ...
        if (user) {
            ...
            fetchCollege();
             ...
             // If user is null (e.g., waiting for auth check), don't set loading false yet? 
             // Actually useAuth should eventually return user or redirect.
        }
    }, [user]);
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                {/* Security Settings */}
                <Card title="Security" className="border border-gray-100 h-fit lg:col-span-1">
